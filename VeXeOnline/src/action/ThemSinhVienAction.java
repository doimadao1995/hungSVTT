...
public class ThemSinhVienAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		if ("submit".equals(sinhVienForm.getSubmit())) { // nhan nut Xac nhan o
															...
															// vien
			/*
			 * String maKhoa = sinhVienForm.getMaKhoa(); String msv =
			 * sinhVienForm.getMsv(); String hoTen = sinhVienForm.getHoTen();
			 * String gioiTinh = sinhVienForm.getGioiTinh(); SinhVienBO
			 * sinhVienBO = new SinhVienBO();
			 */
