...
public class SuaLichTrinhAction extends Action {
	...
	public ActionForward execute(ActionMapping mapping, ActionForm form, HttpServletRequest request,
		...
		if ("submit".equals(lichTrinhForm.getSubmit())) { // nhan nut Xac nhan o
			...
			lichTrinhBO.suaLichTrinh(maLichTrinh, diemDi, diemDen, maGiaVe, thoiGianChay, quangDuong, 1);
			return mapping.findForward("suaLTOK");
		} else { // chuyen sang trang Sua lich trinh
			LichTrinh lichTrinh = lichTrinhBO.getLichTrinh(maLichTrinh);
