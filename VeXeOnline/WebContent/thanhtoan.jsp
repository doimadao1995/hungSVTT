                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <p class="text-bold payoo-info mt10 hidden-xs">
                                                            3. Bạn vui l&ograve;ng đến thanh to&aacute;n tại địa chỉ n&agrave;y trước <span style="color: red">11:30 12-03-2017</span>,
                                                            sau thời gian này vé không thanh toán sẽ tự động huỷ.
                                                        </p>
                                                        <p class="text-bold payoo-info hidden-xs">4. Sau khi thanh toán, bạn sẽ nhận được <span class="">v&eacute; điện tử qua tin nhắn v&agrave; Email thay cho v&eacute; giấy để l&ecirc;n xe</span></p>
                                                        <p class="visible-xs"><b>Lưu &yacute;:</b> Thời gian thanh to&aacute;n: <b style="color: red">11:30 12-03-2017</b>, sau thời gian này vé không thanh toán sẽ tự động huỷ.</p>
                                                            ...
                                                            <label>
                                                                Bạn gặp vấn đề trong quá trình thanh toán? Gọi ngay VeXeRe qua hotline 
                                                                        ...
                                                                        <a href="tel:1900 7070" style="font-size: 18px; color: #F08300;">1900 7070</a>
                                                                            <span style="font-size: 18px; color: #F08300;"> - </span>
                                                                        <a href="tel:1900 969681" style="font-size: 18px; color: #F08300;">1900 969681</a>
                                                                <br /> hoặc gửi email về <span style="color: #F08300;">cs@vexere.com</span>
                                                            </label>
                                                        </div>
                                                    </div>
                                                </div>
